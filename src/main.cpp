...
void
generate_token(mycurlpp::Curl &curl, std::string &token)
{
...
std::string get_auth_token(mycurlpp::Curl &curl)
{
...
void
manipulate_panels(mycurlpp::Curl &curl)
{
...
static void resolve_callback(
    ...
    switch (event) {
        ...
        case AVAHI_RESOLVER_FOUND: {
			...
			;
            mycurlpp::Curl curl(host_name, port);
